      ...
      <div className="p-4">
        <div>
          <div className="flex justify-between">
            <div className="  text-xl leading-7 text-[#1A181E]">Overview</div>
          ...
          <div className="flex gap-6 pt-4">
            <div className="p-5 bg-white rounded-lg gap-4 shadow flex-col justify-start items-start  inline-flex basis-1/2">
              <div className="text-paymentText">Online orders</div>
              <div className="text-[32px]">231</div>
            </div>
            <div className="p-5 bg-white rounded-lg gap-4 shadow flex-col justify-start items-start  inline-flex basis-1/2">
              <div className="text-paymentText ">Amount received</div>
              <div className="text-[32px]">₹23,92,312.19</div>
            </div>
          </div>
        </div>
        <div className="pt-5">
          <div className="text-[#1A181E]  text-xl leading-7 ">
